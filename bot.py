...
from core.handlers.basic import get_start, get_photo, get_greeting, get_location, get_inline
from core.handlers.contact import get_fake_contact, get_true_contact
from core.handlers.callback import select_inline_button
...
async def start():
  ...
  dp.callback_query.register(select_inline_button, F.data.startswith('apple_'))
